...
//
// Author:             Mehak Gupta  megupta@ucsd.edu
...
/**
 * This class contains methods to print and move the board in different directions.
 *
 * Bugs: None
 *
 * @author (Mehak Gupta)
...
public class Board {
    ...
    */
     ...
     */
    private void moveUp() {
        for (int magic =0; magic<grid.length;magic++){
            for (int i = 0; i < grid.length - 1; i++) {
